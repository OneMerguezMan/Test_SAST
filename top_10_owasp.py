...
# --- Vulnérabilités supplémentaires non utilisées ---
def dangerous_eval(user_input):
    # Vulnérabilité : exécution arbitraire de code
    eval(user_input)

def insecure_os_system(cmd):
    # Vulnérabilité : injection de commande système
    os.system(cmd)

def weak_permissions():
    # Vulnérabilité : permissions faibles sur un fichier
    with open('weak.txt', 'w') as f:
        f.write('data')
    os.chmod('weak.txt', 0o777)
